export function Footer() {
  return (
    <>
      <section id="about" className="scroll-mt-20 border-t border-white/10 bg-ink">
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-16 sm:px-8 md:grid-cols-[1fr_1.2fr]">
          <div className="flex items-start gap-3">
            <span className="reg-mark mt-2 text-magenta">
              <span className="reg-mark-circle" />
            </span>
            <h2 className="font-display text-3xl uppercase text-canvas sm:text-4xl">
              How we print
            </h2>
          </div>
      ...
      <footer className="border-t border-white/10 bg-ink">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-5 py-8 text-center sm:flex-row sm:justify-between sm:text-left sm:px-8">
          <div className="flex items-center gap-2 font-display text-lg text-canvas">
